            ...
            <form class="" id="loginForm">
                ...
                <div class="form-step active" id="step-1">
                    <div class="mb-4 btn-group-container text-center">
                        ...
                        <button type="button" class="login-type-btn active-btn" id="loadPartner"><svg
                                xmlns="http://www.w3.org/2000/svg" width="20" height="12" viewBox="0 0 20 12"
                                fill="none">
                                <path
                                    d="M10.3335 0.996094L7.49756 3.29297C7.02588 3.67383 6.93506 4.35937 7.29248 4.84863C7.67041 5.37012 8.40576 5.47266 8.9126 5.07715L11.8218 2.81543C12.0269 2.65723 12.3198 2.69238 12.481 2.89746C12.6421 3.10254 12.604 3.39551 12.3989 3.55664L11.7866 4.03125L15.8589 7.78125V2.25H15.8384L15.7241 2.17676L13.5972 0.814453C13.1489 0.527344 12.6245 0.375 12.0913 0.375C11.4526 0.375 10.8315 0.594726 10.3335 0.996094ZM11.0015 4.64062L9.48682 5.81836C8.56396 6.53906 7.2251 6.35156 6.53369 5.40234C5.8833 4.50879 6.04736 3.26074 6.90576 2.56641L9.34326 0.594727C9.00342 0.451172 8.63721 0.37793 8.26514 0.37793C7.71436 0.375 7.17822 0.539062 6.71826 0.84375L4.60889 2.25V8.8125H5.43506L8.11279 11.2559C8.68701 11.7803 9.57471 11.7393 10.0991 11.165C10.2603 10.9863 10.3687 10.7783 10.4243 10.5615L10.9224 11.0186C11.4937 11.543 12.3843 11.5049 12.9087 10.9336C13.0405 10.79 13.1372 10.623 13.1987 10.4502C13.7671 10.8311 14.5405 10.752 15.0181 10.2305C15.5425 9.65918 15.5044 8.76855 14.9331 8.24414L11.0015 4.64062ZM1.32764 2.25C1.06982 2.25 0.858887 2.46094 0.858887 2.71875V8.8125C0.858887 9.33105 1.27783 9.75 1.79639 9.75H2.73389C3.25244 9.75 3.67139 9.33105 3.67139 8.8125V2.25H1.32764ZM2.26514 7.875C2.38946 7.875 2.50869 7.92439 2.59659 8.01229C2.6845 8.1002 2.73389 8.21943 2.73389 8.34375C2.73389 8.46807 2.6845 8.5873 2.59659 8.67521C2.50869 8.76311 2.38946 8.8125 2.26514 8.8125C2.14082 8.8125 2.02159 8.76311 1.93368 8.67521C1.84577 8.5873 1.79639 8.46807 1.79639 8.34375C1.79639 8.21943 1.84577 8.1002 1.93368 8.01229C2.02159 7.92439 2.14082 7.875 2.26514 7.875ZM16.7964 2.25V8.8125C16.7964 9.33105 17.2153 9.75 17.7339 9.75H18.6714C19.1899 9.75 19.6089 9.33105 19.6089 8.8125V2.71875C19.6089 2.46094 19.3979 2.25 19.1401 2.25H16.7964ZM17.7339 8.34375C17.7339 8.21943 17.7833 8.1002 17.8712 8.01229C17.9591 7.92439 18.0783 7.875 18.2026 7.875C18.327 7.875 18.4462 7.92439 18.5341 8.01229C18.622 8.1002 18.6714 8.21943 18.6714 8.34375C18.6714 8.46807 18.622 8.5873 18.5341 8.67521C18.4462 8.76311 18.327 8.8125 18.2026 8.8125C18.0783 8.8125 17.9591 8.76311 17.8712 8.67521C17.7833 8.5873 17.7339 8.46807 17.7339 8.34375Z"
                                    fill="#175DA8" />
                            </svg> Partner</button>
                    </div>
                    <div class="mb-4 mt-5">
                ...
                <div class="form-step me-3" id="step-2">
                    ...
                    <div class="d-flex justify-content-between mb-5">
                        ...
                        <button type="button" class="btn btn-success w-100 continue-btn"
                            id="step2Continue">Continue</button>
                    </div>
                </div>
