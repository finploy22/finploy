...
WHERE candidate_details.id = ?";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // A column that differs based on the buy candidate or candidate
            ...
            <div class=" candidate-popup p-3">
                ...
                <div class="candidate-meta  mb-3">
                    <div class="mb-2">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M10.0006 9.1714C12.3675 9.1714 14.2863 7.25262 14.2863 4.88569C14.2863 2.51875 12.3675 0.599976 10.0006 0.599976C7.63362 0.599976 5.71484 2.51875 5.71484 4.88569C5.71484 7.25262 7.63362 9.1714 10.0006 9.1714Z"
                                fill="#175DA8" />
                            <path
                                d="M9.99999 19.35C14.1421 19.35 17.5 17.4312 17.5 15.0643C17.5 12.6973 14.1421 10.7786 9.99999 10.7786C5.85786 10.7786 2.5 12.6973 2.5 15.0643C2.5 17.4312 5.85786 19.35 9.99999 19.35Z"
                                fill="#175DA8" />
                        </svg>
                    ...
                    <div>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M3.03516 14.9433C3.03516 16.1276 3.94082 17.0333 5.12515 17.0333H14.8785C16.0628 17.0333 16.9685 16.1276 16.9685 14.9433V9.36996H3.03516V14.9433ZM14.8785 4.49331H13.4851V3.79664C13.4851 3.37864 13.2065 3.09998 12.7885 3.09998C12.3705 3.09998 12.0918 3.37864 12.0918 3.79664V4.49331H7.91181V3.79664C7.91181 3.37864 7.63314 3.09998 7.21515 3.09998C6.79715 3.09998 6.51848 3.37864 6.51848 3.79664V4.49331H5.12515C3.94082 4.49331 3.03516 5.39897 3.03516 6.5833V7.97663H16.9685V6.5833C16.9685 5.39897 16.0628 4.49331 14.8785 4.49331Z"
                                fill="#175DA8" />
                        </svg>
                ...
                <div class="mt-3">
                    ...
                    <?php
                      $resumeFullPath = __DIR__ . '/' . $resume; // resolves to absolute path
                        $safeResumeUrl = htmlspecialchars($resume, ENT_QUOTES, 'UTF-8');
                        
                        if (!empty($resume) && file_exists($resumeFullPath)) {
                    ...
                    //     // User has access: show resume without blur/lock
                    ...
                    //     // Resume exists but access not purchased: show locked blurred version
                    //     // (you can optionally use a placeholder PDF or blurred image preview if you want)
                    //     echo '<div class="resume-preview-container position-relative" style="overflow:hidden;">
                    //         <iframe 
                    //             class="blurred-resume" 
                    //             src="' . $resumeUrlPath . 'locked-preview.pdf" 
                    //             width="100%" 
                    //             height="300px" 
                    //             frameborder="0" 
